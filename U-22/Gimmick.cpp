...
void gimmickMove() {
	...
	//破壊できる壁の処理
	if (g_map.gimmickData[int(g_player.py / CHIPSIZE)][int(g_player.px / CHIPSIZE) + 1] == GIM_3 ||
		g_map.gimmickData[int(g_player.py / CHIPSIZE)][int(g_player.px / CHIPSIZE) - 1] == GIM_3 ) {
