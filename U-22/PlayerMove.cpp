...
void PlayerMove(){
	...
	DrawFormatString(0, 60, 0xffffff, "yc%d", ycount);
	DrawFormatString(0, 80, 0xffffff, "re%d", result);
	DrawFormatString(0, 100, 0xffffff, "dir%d", dir);
	DrawFormatString(0, 120, 0xffffff, "x%d", px);
	DrawFormatString(0, 140, 0xffffff, "y%d", py);
